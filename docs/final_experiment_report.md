...
| Collab pre-Sk epoch6 | 6.85% | 0.42 | 0.0442 | 0.1188 | 0.2067 | 0.0967 |
...
4. **多 epoch 训练收敛**：Epoch 4 为最优点（HR@50=0.2226），Epoch 5-6 出现过拟合（0.2148 → 0.2067），确认 epoch 4 是收敛峰值

5. **Epoch 4 距离 baseline 仅差 7.9%**：用协同 SID 训练的模型，HR@50 从 0.1675 提升至 0.2226，趋近 baseline 的 0.2417
